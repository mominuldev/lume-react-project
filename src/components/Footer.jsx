...
const Footer = () => {
	return (
		<footer className="bg-[#051413]">
			<div className="container py-[80px]">
				<div className="grid lg:grid-cols-6 gap-4 md:grid-cols-4 sm:grid-cols-2">
					<div>
						<img src={FooterLogo.src} alt="footer logo" />

						<a
							href="mailto:hello@lumeweb.com"
							className="inline-block underline my-4  text-[#F8F8F8] text-base leading-[34px] transition ease-in-out duration-300 hover:text-white"
						>
							hello@lumeweb.com
						</a>
					...
					<div>
						<h3 className="text-[#F8F8F8] mb-4 text-lg font-medium">
							Company
						</h3>
						<ul>
							<li>
								<a
									href="#"
									className="text-[#BBBFBF] text-base leading-[34px] transition ease-in-out duration-300 hover:text-white"
								>
									Home
								</a>
							</li>
					...
					<div>
						<h3 className="text-[#8c8686] mb-4 text-lg font-medium">
							Company
						</h3>
						<ul>
							<li>
			...
			<div className="bg-[#030E0D] border-top border-[#0B4542] py-8 ">
				<div className="container">
					<div className="flex items-center justify-between">
						<p className="text-[#E9E9E9] text-sm text-center">
							© 2024 Lume. All rights reserved. Lume is a 503c
							grant recipient.
						</p>
						...
						<div className="flex items-center space-x-5">
							...
							>
								<img src={PathIcon.src} alt="path icon" />
							</a>
							<a
								href="#"
								className="text-white font-medium text-lg"
